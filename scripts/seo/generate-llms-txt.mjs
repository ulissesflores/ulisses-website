...
function generateLlmsTxt(data) {
  ...
  const lines = [
    ...
    `- **Contato:** ${origin} (principal) — atende presencialmente na região de Jundiaí, Itupeva e São Paulo; remotamente para Brasil e exterior.`,
    '',
    '## Áreas de Atuação',
    ...
    '',
    '## Páginas Comerciais',
    `- Consultoria Estratégica em IA, Sistemas Críticos e Soberania Digital: ${origin}/consultoria`,
    `- Palestras, Keynotes e Workshops Executivos: ${origin}/palestras`,
    '- Contato consultoria: consultoria@ulissesflores.com (resposta em até 2 dias úteis)',
    '- Contato palestras: palestras@ulissesflores.com (proposta formal em até 3 dias úteis)',
