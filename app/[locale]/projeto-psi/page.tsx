    ...
    <>
      ...
      <section className='relative w-full bg-neutral-950 py-28 sm:py-36'>
        ...
        <div className='relative mx-auto max-w-4xl px-6 text-center'>
          ...
          <div className='mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center'>
            ...
            <Link href='/whitepapers/projeto-psi' className='inline-flex items-center justify-center rounded-full border border-neutral-700 px-8 py-3.5 text-sm font-semibold text-neutral-300 transition-colors hover:border-neutral-500 hover:text-neutral-100'>
              {t.hero.ctaSecondary}
            </Link>
          </div>
        </div>
      ...
      <section id='contato' className='bg-neutral-950 py-28'>
        <div className='mx-auto max-w-3xl px-6 text-center'>
          ...
          <div className='mt-10'>
            <Link href='/' className='inline-flex items-center justify-center rounded-full bg-emerald-500 px-10 py-4 text-sm font-bold text-neutral-950 shadow-lg shadow-emerald-500/25 transition-all hover:bg-emerald-400 hover:shadow-emerald-400/30'>
              {t.cta.button}
            </Link>
          </div>
        </div>
      ...
      <aside className='bg-neutral-950 pb-20'>
        <div className='mx-auto max-w-4xl px-6 text-center'>
          <Link href='/whitepapers/projeto-psi' className='inline-flex items-center gap-2 text-sm text-neutral-500 transition-colors hover:text-emerald-400'>
            {t.crossLink}
          </Link>
        </div>
      </aside>
