...
> **Methodological note.** Every number in this article was checked by me at the primary source between August 28 and September 4, 2026: the seven 2026 monthly reports from Challenger, Gray & Christmas (page by page; the August one checked on September 4, right after publication), Klarna's prospectus at the SEC, the PDFs of the ILO/World Bank study (WP121), of PwC's 2026 *AI Jobs Barometer* and of the *Anthropic Economic Index* — with the figures read off the image, not off somebody else's summary — plus IBGE, CAGED, Cetic.br, Brasscom and Microsoft's and OpenAI's own pages about Brazil. Challenger's January figure is derived from the year-to-date total (the January monthly report is not on the blog) and is flagged in the figure. Whatever I could not verify is said so in the text, with the reason.
...
| "AI has caused ~174,000 job cuts in the US since 2023" | ✅ and it has already grown | Through July: **184,538**. In August AI fell to the month's no. 4 reason — but it is still no. 1 in the 2026 running total |
...
**Measurement.** The consultancy Challenger, Gray & Christmas, which monitors layoff announcements in the United States, has tracked AI as a stated reason for cuts since 2023. In 2026 alone, through August: **116,175 cuts attributed to AI — around 22% of everything announced in the year, the no. 1 reason year to date** (since 2023, the total closed July at 184,538). From March to July, AI led the reasons for five months running — in July, with **33% of all the cuts that month**. In August the run broke: 3,462 cuts, 4th place for the month, the lowest number since December 2025 — and even so the year's lead did not change hands.

<CountryBarsChart
  dataset="ia-trabalho-challenger-2026-en"
  title="The no. 1 reason for layoffs in the US in 2026, month by month"
  subtitle="Cuts attributed to AI by month in 2026 — year to date: 116,175 (22% of the total)"
  description="Horizontal bars with the job cuts attributed to AI in the United States, month by month in 2026: January 7,624 (a value derived from the year-to-date total), February 4,680, March 15,341, April 21,490, May 38,579 — the peak, June 14,029, July 10,970, when AI accounted for 33% of all the cuts that month, and August 3,462 — the lowest value since December 2025, the month AI fell to the no. 4 reason. The series is jagged: it climbs, collapses and climbs again."
  source="Challenger Report, Feb-Aug 2026, read one by one on Aug 30 and Sep 4, 2026; January derived from the total · ulissesflores.com/trabalho-en"
/>

Look at the shape of the series before you store any number from it: it climbs, collapses, climbs again. May carries a peak (38,579) pulled by financial technology companies; July falls to 10,970 and is *still* the month in which AI most dominated the reasons (33%), because total layoffs fell along with it; August collapses to 3,462 and hands the monthly lead back to good old restructuring. **Real measurement is jagged — be suspicious of a smooth curve.**
...
**3. The Challenger running total in circulation is always one report behind.** Pieces published in August still cited "~174,000 since 2023" (the June figure), when July already read 184,538 — nearly 11,000 more. This article nearly repeated the sin: it closed with July's data and had to be reopened when the August report came out, knocking down AI's five-month run at the top of the monthly ranking into the bargain. It is not a grave error; it is a symptom of how the citation chain works: **people translate the aggregator, not the source — and the source does not stop publishing.**
...
And the usual invitation: **replicate the check.** Challenger's reports are public — August's sits on a page anybody can open:
