...
export const deepResearchArtifacts: Record<string, DeepResearchArtifact> = {
  "2025-little-law-resilience": {
    ...
    "citation": "Ulisses Flores (2026) A Lei de Little como Vetor de Resiliência e Qualidade. Codex Hash Research Lab.",
    "files": {
  ...
  "2025-lstm-asset-prediction": {
    ...
    "citation": "Ulisses Flores (2026) Análise Preditiva de Ativos Financeiros com Modelos LSTM. Codex Hash Research Lab.",
    "files": {
  ...
  "2025-hybrid-cooling-thermodynamics": {
    ...
    "citation": "Ulisses Flores (2026) Análise Termodinâmica e Engenharia de Sistemas Híbridos de Resfriamento. Codex Hash Research Lab.",
    "files": {
  ...
  "2025-iot-data-sovereignty": {
    ...
    "citation": "Ulisses Flores (2026) Arquiteturas Cloudless e Soberania de Dados em IoT. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-historicity-jesus-archaeology": {
    ...
    "citation": "Ulisses Flores (2026) Análise Historiográfica e Arqueológica Exaustiva: A Historicidade de Jesus. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-bitcoin-praxeology": {
    ...
    "citation": "Ulisses Flores (2026) Bitcoin como Ativo de Reserva e a Teoria da Moeda na Escola Austríaca. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-scribal-canonization-ezra": {
    ...
    "citation": "Ulisses Flores (2026) Canonização Escribal: Análise Histórico-Crítica da Formação do Cânon. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-theology-economic-order": {
    ...
    "citation": "Ulisses Flores (2026) Fundamentos Transcendentes da Ordem Econômica. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-agritech-agile-flow": {
    ...
    "citation": "Ulisses Flores (2026) Transformação Ágil e Engenharia de Fluxo em Data Science. Codex Hash Research Lab.",
    "files": {
  ...
  "2024-exegetical-treatise-anthropology": {
    ...
    "citation": "Ulisses Flores (2026) Tratado Exegético sobre a Representação da Moralidade e Antropologia. Codex Hash Research Lab.",
    "files": {
  ...
  "2023-marian-apparitions-critique": {
    ...
    "citation": "Ulisses Flores (2026) A Coroa e a Cruz: Análise Teológica e Fenomenológica das Aparições Marianas. Codex Hash Research Lab.",
    "files": {
  ...
  "2023-holy-club-methodism": {
    ...
    "citation": "Ulisses Flores (2026) O Clube Santo: Arqueologia Espiritual, Teológica e Visual do Metodismo. Codex Hash Research Lab.",
    "files": {
  ...
  "2017-chaos-theory-economics": {
    ...
    "citation": "Ulisses Flores (2026) Teoria do Caos: Emergência e Auto-organização em Mercados. Codex Hash Research Lab.",
    "files": {
