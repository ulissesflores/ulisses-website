export const simulacoes = {
  meta: {
    title: 'Strategic AI Simulations | AI 2027, AGI and Future Scenarios',
    description:
  ...
  cta: {
    ...
    description:
      'Ulisses Flores applies these simulations in corporate workshops, university lectures and keynotes. Get in touch for customized consulting or team presentation.',
    button: 'Talk to Ulisses →',
  },
  faq: {
    sectionTitle: 'Questions about Strategic AI Simulations',
  },
} as const;
