export const projetoPsi = {
  ...
  executiveSummary: {
    ...
    p2: 'While traditional hardware wallets protect against amateur hackers, PSI was architected to withstand state-level adversaries, electromagnetic attacks, physical extortion, and even quantum computers. It is not an incremental improvement.',
  ...
  cta: {
    ...
    description: 'Schedule an executive presentation of Projeto PSI. We discuss licensing models, product roadmap, and investment opportunities.',
    button: 'Get in Touch'
  },
  ...
  whitepaperUI: {
    ...
    faqTitle: 'Questions about Projeto PSI and Hardware Wallet'
  },
  jsonLd: {
