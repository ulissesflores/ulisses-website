export const clubeSanto = {
  meta: {
    title: 'Clube Santo — Theological Institute',
    description: 'Clube Santo is the theological institute and biblical training community founded by Ulisses Flores.',
    keywords: [
      "clube santo",
    ...
    ogDescription: 'Theological institute and biblical training community founded by Ulisses Flores — Researcher, Preacher, and Master\'s student in AI at AGTU.'
  },
  breadcrumb: 'Clube Santo',
  hero: {
    h1: 'Theological Institute and Biblical Training Community',
    lead: 'Clube Santo is the theological institute founded by Ulisses Flores for rigorous biblical training, historiographical analysis, and a study community. It gathers a collection of over 56 sermons, research on scribal canonization, biblical historicity, and transcendent foundations of economic order — connecting theology, history, and science.',
    authority: {
      kicker: 'Academic rigor applied to theological training',
      text: 'As a Researcher, Ulisses Flores applies scientific methodology to biblical analysis — combining archaeology, historiography, textual analysis, and Reformed tradition. Published research includes an exhaustive analysis of the historicity of Jesus (archaeological and historiographical methods) and a historical-critical study of the formation of the biblical canon.'
    },
    credentials: [
      "Researcher",
      "Preacher & Biblical Expositor",
      "Master's Student AGTU",
  ...
  manifesto: {
    ...
    p1: 'No, we\'re not talking about British afternoon tea, but a tea that breathed life into a spiritually dormant England. John Wesley, the protagonist of this story, did not invent any trendy beverage — what he really did was create a cup full of revival, known as The Holy Club.',
    p2: 'The Holy Club, for the uninitiated, was not a welcome club for aspiring saints. It was much more than that. It was a gathering of minds and hearts seeking true connection with God, coupled with relentless intellectual rigor. And what a connection! England was never the same. John Wesley, with his Holy Club, unleashed such a great spiritual revival that even King George II had to adjust his crown.',
  ...
  author: {
    ...
    description: 'Clube Santo founded and curated by Ulisses Flores — Researcher, Preacher, Strategic AI Consultant, and Master\'s student in AI at AGTU.'
  },
  cta: {
