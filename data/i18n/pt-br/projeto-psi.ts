export const projetoPsi = {
  ...
  author: {
    ...
    description:
      'Projeto concebido por Ulisses Flores — Consultor Estratégico de IA, Mestrando em Inteligência Artificial pela AGTU (EUA) e co-inventor de tecnologias blockchain (Codex Hash).',
  },
  faq: {
