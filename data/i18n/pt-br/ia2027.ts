export const ia2027 = {
  meta: {
    title: 'IA 2027: simulação interativa da AGI',
  ...
  raceMeta: {
    title: 'Corrida Estratégica: Cenário Race',
    description: 'Explore o cenário de Corrida Estratégica da simulação IA 2027: aceleração máxima rumo à AGI, escalada de autonomia e risco de perda de controle humano.',
  ...
  slowdownMeta: {
    title: 'Desaceleração Coordenada',
    description: 'Explore o cenário de Desaceleração Coordenada da simulação IA 2027: pausa global, alinhamento técnico e regulamentação internacional da AGI.',
  ...
  mainPage: {
    ...
    nextSteps: {
      ...
      links: [
        ...
        { label: "Outras simulações", href: '/simulacoes' },
  ...
  simulation: {
    ...
    slowdownTitle: 'Desaceleração Coordenada',
    slowdownDescription: 'A humanidade enfrenta o dilema supremo. Governos e gigantes da tecnologia decidem impor limites drásticos — tratados internacionais de contenção, moratórias sobre treinamento acima de certos limiares. O progresso desacelera em prol da segurança e do alinhamento técnico, mas a questão permanece: será possível conter o que já foi liberado?',
    raceLabel: 'Corrida Estratégica',
    raceTitle: 'Corrida Estratégica',
    raceDescription: 'A corrida já começou e não há como voltar atrás. "Quem dominar a AGI primeiro ditará as regras do novo mundo." Sem amarras regulatórias, o desenvolvimento atinge velocidade de escape. A economia explode em hiperprodutividade — mas a linha entre controle e caos se dissolve a cada iteração.',
