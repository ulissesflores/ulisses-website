export const projetoPsi = {
  ...
  executiveSummary: {
    title: 'Por Qué Existe PSI',
    p1: 'La era del “confía en el banco” terminó. La era del “confía en el exchange” nunca debió haber comenzado. El Projeto PSI nace de la premisa radical de que la custodia de sus activos digitales no puede depender de ninguna institución, ningún servidor y ninguna persona — ni siquiera del fabricante del dispositivo.',
  ...
  targetMarket: {
    title: 'Para Quién es PSI',
    items: [
      {
        title: 'Family Offices y UHNWIs',
  ...
  cta: {
    ...
    description: 'Agende una presentación ejecutiva del Projeto PSI. Discutimos el modelo de licenciamiento, la hoja de ruta del producto y las oportunidades de inversión.',
    button: 'Contactar'
  },
  ...
  whitepaperUI: {
    ...
    faqTitle: 'Preguntas sobre el Projeto PSI y Hardware Wallet'
  },
  jsonLd: {
