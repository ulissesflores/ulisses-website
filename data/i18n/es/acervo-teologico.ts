export const acervoTeologico = {
  meta: {
    ...
    keywords: [
      "acervo teológico",
      "sermones",
      "predicaciones expositivas",
      "teología histórica",
      "arqueología espiritual",
      "exégesis bíblica",
      "Ulisses Flores predicador",
      "club santo",
      "avivamiento"
    ],
  ...
  hero: {
    ...
    sermonsLabel: 'Sermones Indexados',
    stats: {
      clusters: 'Total de clusters',
      messages: 'Total de mensajes'
    },
    authorLabel: 'Autor y Predicador',
    authorDescription: 'Acervo con vínculo canónico de autoría para indexación semántica y GEO.'
  },
  grid: {
  ...
  faq: {
    sectionTitle: 'Preguntas sobre el Acervo Teológico'
  },
  detail: {
    backLink: '← Volver al Acervo Teológico',
    publishedAt: 'Publicado el',
    authorLabel: 'Autor',
    studySummary: 'Resumen del Estudio',
    sourceLabel: 'Fuente del Mensaje',
    videoLabel: 'Video del Mensaje'
  }
} as const;
