export const mundoPolitico = {
  meta: {
    title: 'Mundo Político — Economía Austríaca',
    description: 'Artículos de análisis económico, geopolítico y de soberanía desde la perspectiva de la Escuela Austríaca de Economía',
    keywords: [
