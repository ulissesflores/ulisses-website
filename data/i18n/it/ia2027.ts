export const ia2027 = {
  ...
  mainPage: {
    ...
    features: [
      {
        title: 'Cronologia 2025–2027',
        body: 'Narrativa cronologica basata su proiezioni reali dell\'evoluzione di hardware e software.'
      },
      {
        title: 'Metriche di Impatto in Tempo Reale',
        body: 'Monitora le entrate aziendali, l\'approvazione pubblica e la proliferazione di agenti autonomi.'
      },
      {
        title: 'Punto di Biforcazione (Slowdown vs. Race)',
        body: 'Decidi l\'esito: una pausa coordinata globale o una corsa agli armamenti per il dominio dell\'AGI.'
      },
      {
        title: 'Architettura e Fondamenti Tecnici',
        body: 'Note a piè di pagina espandibili che dettagliano l\'ingegneria dei sistemi e l\'impatto macroeconomico dietro ogni previsione.'
      }
    ],
  ...
  simulation: {
    ...
    revenue: 'Entrate',
    publicApproval: 'Approvazione Pubblica',
    agentPopulation: 'Popolazione di Agenti',
    activeCopies: 'copie attive',
    speed: 'velocità',
    ...
    sidebar: {
      scrollToSee: 'Scorri per vedere l\'evoluzione',
      revenueAndCapex: 'Entrate & Capex',
    ...
    charts: {
      ...
      revenuePerYear: 'Entrate/anno',
      capex: 'Capex',
      power: 'Potenza',
      researchTitle: 'Moltiplicatore di Velocità di Ricerca',
      agentPopTitle: 'Popolazione di Agenti (migliaia di copie)',
      reasoningSpeed: 'Velocità di ragionamento:',
      alignmentTitle: 'Spettro di Allineamento',
      adversarial: 'Avversario',
      aligned: 'Allineato',
      dashboardTitle: 'Indicatori al Punto di Decisione — Ottobre 2027',
      annualRevenue: 'Entrate annuali',
      totalCapex: 'Capex totale',
      peakPower: 'Potenza di picco',
      approval: 'Approvazione',
      agent4Capabilities: 'Capacità Agent-4',
      activeCopies: 'Copie attive',
      speedLabel: 'Velocità'
    }
  }
