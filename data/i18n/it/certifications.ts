export const certifications = {
  meta: {
    title: 'Certificazioni Tecniche in IA',
    description: 'Portfolio di certificazioni tecniche di Ulisses Flores — Consulente Strategico di IA, Relatore e Studente di Master AGTU.',
    keywords: [
      "certificazioni IA",
