export const home = {
  meta: {
    title: 'Ulisses Flores | יועץ בינה מלאכותית, דובר וחוקר',
    description: 'Ulisses Flores — כלכלן, יועץ אסטרטגי לבינה מלאכותית, דובר ומועמד לתואר שני בבינה מלאכותית ב-AGTU. מחקרים בבינה מלאכותית, Blockchain, כלכלה ומערכות מורכבות. מבוסס בז\'ונדיאי/סאו פאולו, משרת את כל ברזיל.',
    keywords: [
      "Ulisses Flores",
    ...
    ogTitle: 'Ulisses Flores | יועץ בינה מלאכותית, דובר וחוקר',
    ogDescription: 'Ulisses Flores — יועץ אסטרטגי לבינה מלאכותית, דובר ומועמד לתואר שני AGTU. מחקרים בבינה מלאכותית, Blockchain וכלכלה.',
  ...
  engineering: {
    ...
    products: {
      ...
      bioBytes: {
        ...
        desc: 'מערכת לשימור דיגיטלי של זיכרון ומורשת ביוגרפית עם קריפטוגרפיה חזקה וחתימה דיגיטלית.',
        tags: [
          "SECURITY",
          "CRYPTOGRAPHY",
          "BLOCKCHAIN"
