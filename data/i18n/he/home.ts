export const home = {
  meta: {
    title: 'Ulisses Flores | יועץ בינה מלאכותית',
    description: 'Ulisses Flores — כלכלן, יועץ אסטרטגי לבינה מלאכותית, דובר ומועמד לתואר שני בבינה מלאכותית ב-AGTU. מחקרים בבינה מלאכותית, Blockchain, כלכלה ומערכות מורכבות.',
    keywords: [
      "Ulisses Flores",
