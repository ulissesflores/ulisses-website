export const projetoPsi = {
  ...
  executiveSummary: {
    ...
    p1: 'עידן ה\'סמוך על הבנק\' הסתיים. עידן ה\'סמוך על הבורסה\' מעולם לא היה צריך להתחיל. Projeto PSI נולד מההנחה הרדיקלית ששמירת הנכסים הדיגיטליים שלך אינה יכולה להיות תלויה בשום מוסד, שרת או אדם — אפילו לא ביצרן המכשיר.',
    p2: 'בעוד ש-hardware wallets מסורתיים מגנים מפני האקרים חובבים, Projeto PSI תוכנן לעמוד בפני יריבים מדינתיים, התקפות אלקטרומגנטיות, סחיטה פיזית ואפילו מחשבים קוונטיים. זו אינה שיפור מצטבר.',
  ...
  pillars: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'המפתח הפרטי אינו מאוחסן — בשום מקום. הוא משוחזר באופן זמני באמצעות טביעת האצבע הייחודית של הסיליקון (SRAM PUF) וקורס לאחר כל שימוש. אין זרע לגנוב.'
      },
      {
  ...
  targetMarket: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'שמירה ריבונית של עתודות דיגיטליות לאומיות ו-CBDCs עם עמידות בפני התקפות מדינה.'
      }
    ]
  },
  stats: {
    ...
    items: [
      ...
      {
        value: '3×',
        label: 'יתירות מודולרית משולשת. כל פעולה מאומתת בקונצנזוס של 3 מעבדים.'
      },
      {
        value: 'Q-Day Ready',
  ...
  cta: {
    ...
    description: 'קבעו מצגת מנהלים של Projeto PSI. נדון במודל רישוי, roadmap מוצר והזדמנויות השקעה.',
    button: 'צרו קשר'
  },
  crossLink: '📄 קרא את המסמך הטכני המלא →',
  whitepaperUI: {
    kicker: 'מסמך טכני',
    ...
    faqTitle: 'שאלות על Projeto PSI ו-Hardware Wallet'
  },
  jsonLd: {
