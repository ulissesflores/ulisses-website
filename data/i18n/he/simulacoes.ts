export const simulacoes = {
  meta: {
    title: 'סימולציות אסטרטגיות של AI',
    description: 'חקור סימולציות אינטראקטיביות על עתיד הבינה המלאכותית וה-AGI, שנוצרו על ידי Ulisses Flores — יועץ אסטרטגי ל-AI, דובר וסטודנט לתואר שני ב-AI ב-AGTU.',
    keywords: [
