export const mundoPolitico = {
  meta: {
    title: 'Mundo Político — כלכלה אוסטרית',
    description: 'מאמרי ניתוח כלכלי, גיאופוליטיקה וריבונות מנקודת המבט של האסכולה האוסטרית לכלכלה, נכתבו על ידי Ulisses Flores.',
    keywords: [
    ...
    ogDescription: 'ניתוחי כלכלה, גיאופוליטיקה וריבונות דרך עדשת האסכולה האוסטרית, מאת Ulisses Flores — כלכלן, יועץ AI וסטודנט לתואר שני ב-AGTU.'
  },
  breadcrumb: 'Mundo Político',
  hero: {
    h1: 'כלכלה אוסטרית, גיאופוליטיקה וריבונות דיגיטלית',
    lead: 'מאמרי ניתוח כלכלי מנקודת המבט של האסכולה האוסטרית לכלכלה — פרקסאולוגיה, ריבונות מוניטרית, גיאופוליטיקה גלובלית ותפקידו של הביטקוין כמאגר ערך. נכתבו ונערכו על ידי Ulisses Flores — כלכלן, יועץ אסטרטגי ל-AI, מרצה וסטודנט לתואר שני בבינה מלאכותית ב-AGTU.',
    authority: {
