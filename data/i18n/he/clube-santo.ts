export const clubeSanto = {
  meta: {
    ...
    ogDescription: 'מכון תיאולוגי וקהילה להכשרה מקראית שנוסדו על ידי Ulisses Flores — חוקר, מטיף וסטודנט לתואר שני ב-AI ב-AGTU.'
  },
  breadcrumb: 'Clube Santo',
  hero: {
    h1: 'מכון תיאולוגי וקהילה להכשרה מקראית',
    lead: 'Clube Santo הוא המכון התיאולוגי שנוסד על ידי Ulisses Flores להכשרה מקראית קפדנית, ניתוח היסטוריוגרפי וקהילת לימוד. הוא מאגד אוסף של למעלה מ-56 דרשות, מחקרים על קאנוניזציה סופרית, היסטוריות מקראית ויסודות טרנסצנדנטיים של הסדר הכלכלי — המקשרים תיאולוגיה, היסטוריה ומדע.',
    authority: {
      kicker: 'קפדנות אקדמית מיושמת להכשרה תיאולוגית',
      text: 'כחוקר, Ulisses Flores מיישם מתודולוגיה מדעית לניתוח מקראי — המשלב ארכיאולוגיה, היסטוריוגרפיה, ניתוח טקסטואלי ומסורת רפורמית. המחקרים שפורסמו כוללים ניתוח מקיף של ההיסטוריות של ישו (שיטות ארכיאולוגיות והיסטוריוגרפיות) ומחקר היסטורי-ביקורתי של היווצרות הקאנון המקראי.'
    },
    credentials: [
      "חוקר",
      "מטיף ומפרש מקראי",
  ...
  manifesto: {
    ...
    p1: 'לא, אנחנו לא מדברים על תה של חמש אחר הצהריים הבריטי, אלא על תה שהפיח רוח חיים באנגליה רדומה רוחנית. ג\'ון וסלי, גיבור הסיפור הזה, לא המציא שום משקה אופנתי — מה שהוא באמת עשה היה ליצור כוס מלאה בהתעוררות, הידוע בשם Clube Santo.',
    p2: 'Clube Santo, למי שלא ידע, לא היה מועדון קבלת פנים לשואפי קדושה. זה היה הרבה יותר מזה. זו הייתה התכנסות של מוחות ולבבות שחיפשו את הקשר האמיתי עם אלוהים, בשילוב עם קפדנות אינטלקטואלית בלתי מתפשרת. ואיזה קשר! אנגליה מעולם לא הייתה כפי שהייתה. ג\'ון וססלי, עם Clube Santo שלו, עורר התעוררות רוחנית כה גדולה שאפילו המלך ג\'ורג\' השני נאלץ להתאים את כתר מלכותו.',
  ...
  author: {
    label: 'מייסד וחוקר',
    description: 'Clube Santo נוסד ונאצר על ידי Ulisses Flores — חוקר, מטיף, יועץ אסטרטגי ל-AI וסטודנט לתואר שני ב-AI ב-AGTU.'
  },
  cta: {
